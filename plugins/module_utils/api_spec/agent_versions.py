...
class AgentVersionsSpec:
    ...
    def spec(cls):
        ...
        return {
            ...
            "features_enabled": {"type": "list", "elements": "str", "required": False,
            ...
            "end_of_support_date": {"type": "str", "required": False,
                                   "description": "Filter by end of support date (format: YYYY-MM-DD)"},
            "release_notes_url": {"type": "str", "required": False,
            ...
            "exact_version": {"type": "bool", "required": False, "default": False,
...
class AgentVersionsInfoSpec:
    ...
    def spec(cls):
        ...
        return {
            ...
            "platform": {"type": "list", "elements": "str", "required": False,
                        "description": "Filter agent versions by platform compatibility"},
            "features": {"type": "list", "elements": "str", "required": False,
