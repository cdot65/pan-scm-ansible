...
from ansible_collections.cdot65.scm.plugins.module_utils.api_spec.syslog_server_profiles_info import SyslogServerProfilesInfoSpec
    ...
    try:
        ...
        if module.params.get("name"):
            ...
            try:
                ...
                syslog_server_profile = client.syslog_server_profile.fetch(name=name, **container_params)
            ...
            try:
                syslog_server_profiles = client.syslog_server_profile.list(**container_params, **filter_params)

                # Serialize response for Ansible output
                result["syslog_server_profiles"] = [serialize_response(profile) for profile in syslog_server_profiles]
