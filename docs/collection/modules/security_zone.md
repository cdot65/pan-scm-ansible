...
- [Security Zone Configuration Object](#security-zone-configuration-object)
  - [Table of Contents](#table-of-contents)
  - [Overview](#overview)
  - [Core Methods](#core-methods)
  - [Security Zone Model Attributes](#security-zone-model-attributes)
    - [User-ID Mapping Attributes](#user-id-mapping-attributes)
  ...
  - [Best Practices](#best-practices)
    - [Zone Naming and Design](#zone-naming-and-design)
    - [Zone Structure](#zone-structure)
    - [User-ID Configuration](#user-id-configuration)
    - [Log Settings](#log-settings)
    - [Security Policy Integration](#security-policy-integration)
