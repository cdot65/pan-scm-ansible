...
- [Url Categories Configuration Object](#url-categories-configuration-object)
  - [Table of Contents](#table-of-contents)
  - [Overview](#overview)
  - [Core Methods](#core-methods)
  - [URL Category Model Attributes](#url-category-model-attributes)
    - [URL List Type Configuration](#url-list-type-configuration)
    - [Category Match Type Configuration](#category-match-type-configuration)
