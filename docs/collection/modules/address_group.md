...
- [Address Group Configuration Object](#address-group-configuration-object)
  - [Table of Contents](#table-of-contents)
  - [Overview](#overview)
  - [Core Methods](#core-methods)
  - [Address Group Model Attributes](#address-group-model-attributes)
    - [Dynamic Filter Attributes](#dynamic-filter-attributes)
  ...
  - [Best Practices](#best-practices)
    - [Group Type Selection](#group-type-selection)
    - [Static Group Management](#static-group-management)
    - [Dynamic Group Filters](#dynamic-group-filters)
