...
03. [IKE Gateway Model Attributes](#ike-gateway-model-attributes)
...
IKE gateways define the parameters for establishing VPN tunnels with remote endpoints. Different
