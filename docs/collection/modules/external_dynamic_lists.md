...
- [External Dynamic Lists Configuration Object](#external-dynamic-lists-configuration-object)
  - [Table of Contents](#table-of-contents)
  - [Overview](#overview)
  - [Core Methods](#core-methods)
  - [External Dynamic List Model Attributes](#external-dynamic-list-model-attributes)
    - [List Type Attributes](#list-type-attributes)
    - [Update Interval Attributes](#update-interval-attributes)
