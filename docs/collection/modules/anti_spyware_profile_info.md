...
The `anti_spyware_profile_info` module provides functionality to gather information about anti-spyware profile objects in Palo Alto Networks' Strata Cloud Manager. This is an information-gathering module that doesn't make any changes to the system. It supports retrieving a specific anti-spyware profile by name or listing all profiles with various filter options including cloud inline analysis, rules, and container filters.
