...
The `application` module provides functionality to manage custom application objects in Palo Alto
Networks' Strata Cloud Manager. This module allows you to create, update, and delete application
...
!!! note * Category, subcategory, technology, and risk are required when state is "present".
