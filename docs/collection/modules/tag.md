...
The `tag` module provides functionality to manage tag objects in Palo Alto Networks' Strata Cloud Manager. This module allows you to create, update, and delete tag objects that can be used to categorize and organize various resources within SCM. Tags are metadata labels that can be attached to objects for filtering, policy application, and organization.
